...
void ov7725_eagle_port_init()
{
    ...
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTD_B0_IN, (void *)ov7725_eagle_img_buff, PTC18, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTC18, ALT1 | DMA_FALLING | PULLDOWN );         //PCLK
...
reg_s ov7725_eagle_reg[] =
{
    ...
    {OV7725_SDE          , 0x04},
    {OV7725_BRIGHT       , 0x00},
    {OV7725_CNST         , 0x37}, //调阈值（0x32 0x3F）
    {OV7725_SIGN         , 0x06},
    {OV7725_UVADJ0       , 0x11},
    {OV7725_UVADJ1       , 0x02},
